...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#CC8F00"));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "Failed JSON!", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                loadingPB.setVisibility(View.GONE);
                Toast.makeText(MainActivity.this, "Failed! Try Reloading", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
                HashMap<String,String> headers = new HashMap<>();
                headers.put("X-CMC_PRO_API_KEY","2293c55f-ea2c-4974-9d93-b21f1d708b4a");
                return headers;
            }
        };
