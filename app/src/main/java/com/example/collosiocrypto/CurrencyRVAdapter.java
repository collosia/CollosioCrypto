...
public class CurrencyRVAdapter extends RecyclerView.Adapter<CurrencyRVAdapter.ViewHolder>{
    ...
    public CurrencyRVAdapter(ArrayList<CurrencyRVModal> currencyRVModalsArrayList, Context context) {
        this.currencyRVModalsArrayList = currencyRVModalsArrayList;
        this.context = context;
    }
    public void filterList(ArrayList<CurrencyRVModal> filteredList){
        currencyRVModalsArrayList = filteredList;
    ...
    public void onBindViewHolder(@NonNull CurrencyRVAdapter.ViewHolder holder, int position) {
        CurrencyRVModal currencyRVModal = currencyRVModalsArrayList.get(position);
    ...
    public int getItemCount() {
        return currencyRVModalsArrayList.size();
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            rateTV = itemView.findViewById(R.id.idRVCurrencyRate);
